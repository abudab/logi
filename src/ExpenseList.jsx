...
class ExpenseList extends React.Component {
    ...
    constructor(props) {
        ...
        this.state.sorting =
            {order: "asc", column: ""};
        this.state.sortedExpenses = this.props.data;
        this.state.filter =
    ...
    componentWillReceiveProps(nextProps) {
        ...
        this.setState({
            sortedExpenses: this.sortAndFiler(nextProps.data, this.state.filter,column, order)
        })
    }
    ...
    onFilter = (filterColumn) => (e) => {
        ...
        this.setState({
            filter: filteredArr,
            sortedExpenses: this.sortAndFiler(this.props.data,filteredArr, column, order)
        })
    }
        ...
        return <div className="expenses-container">
            <div>
                <table className="table table-hover">
                    ...
                    <TableRowSum data={this.state.sortedExpenses}/>
